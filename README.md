...
> [!WARNING]
> The `conda-token` implementation has been moved to the [`anaconda-auth`](https://github.com/anaconda/anaconda-auth) repository as of `conda-token=0.7.0`, and this repository is deprecated and has been archived.
